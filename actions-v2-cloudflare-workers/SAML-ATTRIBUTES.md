...
# SAML Attributes Injection

The [`saml-attributes.js`](/actions-v2-cloudflare-workers/scripts/saml-attributes/saml-attributes.js) Action script demonstrates how to add custom attributes to the SAML response when Zitadel is acting as a SAML IDP. This example sets a static value, but it can be easily adapted to match another use case.
...
5. **Returns** a JSON object with appended attributes
...
Open your **Zitadel Console** and navigate to the **Actions** tab.  
   - Create a new function → **presamlresponse**
   - Select the **SAML Attributes** target
...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/zitadel/actions/tree/main/actions-v2-cloudflare-workers/scripts/saml-attributes)
